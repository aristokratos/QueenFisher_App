    ...
    <section className="values">
      <div className="values__container">
        <div className="values__left">
          <h2>Our Values that Would Help You</h2>
          <p>
            At Queenfisher, we encourage creativity and innovation in cooking by
            promoting the discovery of new and creative recipes, as well as the
            use of innovative cooking techniques.
          </p>
          <p>
            Queenfisher is accessible to all users, regardless of their physical
            abilities or technological savvy, to ensure accessibility for all.
          </p>
