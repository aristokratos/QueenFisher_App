  ...
  return (
    ...
    <div className={styles['title']}>
      ...
      <div className={styles['meal']}>
        ...
        <select className={styles['ingredients']} name="mealType" value={formData.mealType || ""} onChange={handleInputChange} required>
         <option value=""></option>
     ...
     <div className={styles['ingredient']}>
        <label> Ingredients:
        <select className={styles['ingredients']} name="ingredients" value={formData.ingredients || ""} onChange={handleInputChange} required>
              <option value=""></option>
                {mealTypeOptions.map((option) => (
              <option key={option} value={option}>{option}</option>
              ))}
      ...
      <div className={styles['picture']}>
        <div className={styles['pic-inner']}>
            ...
            {formData.picture && (
            <img src={formData.picture} alt="Recipe" className="recipe-picture" />
            )}
            </div>
        <div>
      ...
      <div className={styles['procedure']}>
            <div className={styles['proMenu']}>
                <p>
                    Procedure:
                    <textarea name="procedure" value={formData.procedure} onChange={handleInputChange} required />
                </p>
                <p className={styles['country']}>
                    Country:
                    {/* <select name="country" value={formData.country} onChange={handleInputChange} required /> */}
             <select className={styles['country']} name="country" value={formData.country || ""} onChange={handleInputChange} required>
              <option value=""></option>
        ...
        <button className={styles.button}><Link to="/recipe-confirm">Generate</Link></button>
        </div>
